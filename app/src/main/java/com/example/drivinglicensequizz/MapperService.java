...
public class MapperService {
    ...
    public ContestStatus mapContestStatusRealmToContestStatus(ContestStatusRealm contestStatusRealm) {
        ContestStatus contestStatus = new ContestStatus();
        contestStatus.setId_typeOfContest(contestStatusRealm.getId_typeOfContest());
        contestStatus.setId(contestStatusRealm.getId());
        contestStatus.setTypeOfContest(contestStatusRealm.getTypeOfContest());
        contestStatus.setStatus(contestStatusRealm.getStatus());
